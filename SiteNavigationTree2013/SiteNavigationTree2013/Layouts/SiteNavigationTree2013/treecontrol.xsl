		...
		<TR style="height: 17px;">
			<TD ALIGN="center" width="16px" valign="middle" height="17" nowrap="1">
				<xsl:choose>
					<xsl:when test='$cChildren &gt; 0'>
						<xsl:choose>
							<xsl:when test="@isexpanded = 'false'">
								<img state="expand" src="/_layouts/15/images/SiteNavigationTree2013/plus.gif" style="cursor:hand;" BORDER="0" ONCLICK="TC_ShowSubFolders(this, true, '_ClientID_');">
							...
							<xsl:otherwise>
								<img state="collapse" src="/_layouts/15/images/SiteNavigationTree2013/minus.gif" style="cursor:hand;" BORDER="0" ONCLICK="TC_ShowSubFolders(this, true, '_ClientID_');">
									<xsl:attribute name="ID">
										<xsl:value-of select="@ID" />
									</xsl:attribute>
								</img>
					...
					<xsl:otherwise>
						<img src="/_layouts/15/images/SiteNavigationTree2013/blank.gif" BORDER="0" width="16" height="16" />
					</xsl:otherwise>
				</xsl:choose>
			</TD>
			<TD width="2px">
				<img src="/_layouts/15/images/SiteNavigationTree2013/blank.gif" BORDER="0" width="2" height="17" />
			</TD>
			<TD valign="middle" height="17" width="16">
				<xsl:choose>
					<xsl:when test="@Icon = ''">
						<img src="/_layouts/15/images/SiteNavigationTree2013/blank.gif" BORDER="0" width="16" height="16" />
					</xsl:when>
                  ...
                  <xsl:value-of select="@Title" />
						...
						<TD class="ms-menuimagecell" id="hiddencolumn" style="display:none;visibility:hidden;">
							<SPAN id="spanhiddencolumn" style="cursor:hand;" class="item">
								<IMG id="imagehiddencolumn" SRC="/_layouts/15/images/SiteNavigationTree2013/downarrw.gif" />
							</SPAN>
						</TD>
					</TR>
				</TABLE>
